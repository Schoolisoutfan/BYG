    ...
    public boolean place(Set<BlockPos> treeBlockSet, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < 256) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.offset(Direction.DOWN), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, 3, 2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, 4, 2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, 5, 3), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, 8, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, 8, 1), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 9, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, 9, 2), boundsIn);
                this.pollen(treeBlockSet, worldIn, mainmutable.add(0, 9, 0), boundsIn);
                this.pollen(treeBlockSet, worldIn, mainmutable.add(-1, 9, 1), boundsIn);
