        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            ...
            if (!isDesiredGroundwDirtTag(worldIn, blockpos, Blocks.GRASS_BLOCK, BYGBlockList.MOSSY_STONE)) {
                ...
                for (int buildRoot = 0; buildRoot <= 5; buildRoot++) {
                    ...
                    this.treeBranch(treeBlockSet, worldIn, rootMutable7, boundsIn);
                    this.treeBranch(treeBlockSet, worldIn, rootMutable8, boundsIn);
                    this.treeBranch(treeBlockSet, worldIn, rootMutable9, boundsIn);
                    this.treeBranch(treeBlockSet, worldIn, rootMutable10, boundsIn);
                    this.treeBranch(treeBlockSet, worldIn, rootMutable11, boundsIn);
                    this.treeBranch(treeBlockSet, worldIn, rootMutable12, boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-3, randTreeHeight + 3, 3), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-3, randTreeHeight + 3, 4), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, randTreeHeight + 2, 6), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, randTreeHeight + 2, 6), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight + 3, -6), boundsIn);
