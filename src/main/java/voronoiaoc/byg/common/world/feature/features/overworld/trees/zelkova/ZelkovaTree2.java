...
//                        this.leafs(worldIn, posX1 + posXLeafWidth - 1, topTrunkHeight + 1, posZ1 + posZLeafWidthL0 - 1, boundsIn, treeBlockSet);
                        ...
                        if (posXLeafWidth <= 1 && posZLeafWidthL0 <= 1 && posZLeafWidthL0 >= -1 && posXLeafWidth >= -1) {
                            ...
                            this.leafs(worldIn, posX1 + posXLeafWidth, topTrunkHeight - 9, posZ1 + posZLeafWidthL0, boundsIn, treeBlockSet);
                            this.leafs(worldIn, posX1 + posXLeafWidth, topTrunkHeight - 13, posZ1 + posZLeafWidthL0, boundsIn, treeBlockSet);
                        }
                        ...
                        this.leafs(worldIn, posX1, topTrunkHeight - 7, posZ1 + 1, boundsIn, treeBlockSet);
                        //------
                        this.leafs(worldIn, posX1 + 2, topTrunkHeight - 8, posZ1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 2, topTrunkHeight - 8, posZ1, boundsIn, treeBlockSet);
                        ...
                        this.leafs(worldIn, posX1, topTrunkHeight - 11, posZ1 + 1, boundsIn, treeBlockSet);
                        //------
                        this.leafs(worldIn, posX1 + 2, topTrunkHeight - 12, posZ1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 2, topTrunkHeight - 12, posZ1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight - 12, posZ1 - 2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight - 12, posZ1 + 2, boundsIn, treeBlockSet);
                        ...
                        this.leafs(worldIn, posX1, topTrunkHeight - 14, posZ1 + 2, boundsIn, treeBlockSet);
                        //------
                        this.leafs(worldIn, posX1 + 1, topTrunkHeight - 15, posZ1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 1, topTrunkHeight - 15, posZ1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight - 15, posZ1 - 1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight - 15, posZ1 + 1, boundsIn, treeBlockSet);
                        //------
