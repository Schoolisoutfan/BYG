        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.offset(Direction.DOWN), Blocks.GRASS_BLOCK)) {
                ...
                for (int groundUpLogRemover = 0; groundUpLogRemover < randTreeHeight; ++groundUpLogRemover) {
                    ...
                    this.treelog(treeBlockSet, worldIn, blockpos2.north().down(7), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.north().down(11), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.south().down(6), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.south().down(10), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.east().down(4), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.east().down(8), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.west().down(3), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.west().down(8), boundsIn);
                }
...
//                        this.leafs(worldIn, posX1 + posXLeafWidth - 1, topTrunkHeight + 1, posZ1 + posZLeafWidthL0 - 1, boundsIn, treeBlockSet);
                        ...
                        this.leafs(worldIn, posX1 - 1, topTrunkHeight - 6, posZ1 - 1, boundsIn, treeBlockSet);
                        ...
                        this.leafs(worldIn, posX1, topTrunkHeight - 8, posZ1 + 1, boundsIn, treeBlockSet);
                        ...
                        this.leafs(worldIn, posX1 - 1, topTrunkHeight - 10, posZ1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 + 1, topTrunkHeight - 10, posZ1 - 1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 1, topTrunkHeight - 10, posZ1 - 1, boundsIn, treeBlockSet);
