    ...
    public boolean place(Set<BlockPos> treeBlockSet, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            ...
            if (!isDesiredGround(worldIn, blockpos, BYGBlockList.EMBUR_NYLIUM)) {
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(5, 6, -3), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(5, 7, -3), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, 8, -3), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, 9, -2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-1, 9, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, 10, -2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-1, 10, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-2, 10, 2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, 11, -2), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-2, 13, 2), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, 16, 2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-2, 17, -2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, 17, 2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-2, 18, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 5, -4), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(6, 5, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(7, 5, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 5, -3), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(5, 5, -3), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(6, 5, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(7, 5, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 5, -2), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(4, 5, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(7, 5, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, 5, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(5, 5, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(6, 5, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, 6, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(5, 6, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(6, 6, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, 6, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(6, 6, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, 6, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(5, 6, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(6, 6, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(5, 7, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, 7, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(6, 7, -3), boundsIn);
                ...
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(1, 7, 2), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(3, 7, 2), boundsIn);
                ...
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(3, 7, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, 7, 3), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, 11, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 11, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 11, -3), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(2, 11, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 11, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 11, -2), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(2, 11, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 11, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 11, -1), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(0, 11, -1), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 12, -3), boundsIn);
                ...
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(-2, 12, 3), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 13, 1), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(-2, 13, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 13, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 13, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-4, 13, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 13, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-4, 13, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 13, 3), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(-2, 13, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 13, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 13, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 13, 4), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 17, 0), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 17, 1), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(1, 17, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, 17, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 17, 2), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(1, 17, 2), boundsIn);
                ...
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(3, 17, 3), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 18, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 18, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 18, -4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-4, 18, -3), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(-3, 18, -3), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(-2, 18, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 18, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-4, 18, -2), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(-1, 18, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 18, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-4, 18, -1), boundsIn);
                this.leafs2(treeBlockSet, worldIn, mainmutable.add(-2, 18, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, 18, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 18, 0), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 18, 0), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 18, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 18, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, 18, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 18, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 18, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, 18, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 18, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 18, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 19, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 19, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 19, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 19, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 19, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 19, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 19, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 19, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 19, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 19, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, 19, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 19, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, 19, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, 19, 3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 20, -3), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, 20, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 20, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, 20, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, 20, -1), boundsIn);
            }
        }
        return true;
    }
