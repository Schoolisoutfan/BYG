        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            ...
            if (((IWorld) worldIn).getBlockState(pos.down()).getBlock() != Blocks.GRASS_BLOCK && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != Blocks.RED_SAND && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != Blocks.COARSE_DIRT) {
                ...
                for (int groundUpLogRemover = 0; groundUpLogRemover < randTreeHeight; ++groundUpLogRemover) {
                    ...
                    this.treelog(treeBlockSet, worldIn, blockpos2.east(2).north(), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.east(3).north(2).up(), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.east(4).north().up(2), boundsIn);
                    ...
                    this.treelog(treeBlockSet, worldIn, blockpos2.south(3).west(2).up(), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.south(3).west(2).up(2), boundsIn);
                    this.treelog(treeBlockSet, worldIn, blockpos2.south(3).west(3).up(3), boundsIn);
                }
                ...
                for (int posXLeafWidth = -leavessquarespos; posXLeafWidth <= leavessquarespos; ++posXLeafWidth) {//has to do with leaves
                    for (int posZLeafWidthL0 = -leavessquarespos; posZLeafWidthL0 <= leavessquarespos; ++posZLeafWidthL0) {
                        ...
                        //Bottom Leaves
                        this.leafs(worldIn, posX2 + posXLeafWidth, topTrunkHeight + 4, posZ2 + posZLeafWidthL0, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX2 + posXLeafWidth - 2, topTrunkHeight + 4, posZ2 + posZLeafWidthL0, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX2 + posXLeafWidth - 1, topTrunkHeight + 4, posZ2 + posZLeafWidthL0 + 1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX2 + posXLeafWidth - 1, topTrunkHeight + 4, posZ2 + posZLeafWidthL0 - 1, boundsIn, treeBlockSet);

                        this.leafs(worldIn, posX3 + posXLeafWidth, topTrunkHeight + 3, posZ3 + posZLeafWidthL0, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX3 + posXLeafWidth - 2, topTrunkHeight + 3, posZ3 + posZLeafWidthL0, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX3 + posXLeafWidth - 1, topTrunkHeight + 3, posZ3 + posZLeafWidthL0 + 1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX3 + posXLeafWidth - 1, topTrunkHeight + 3, posZ3 + posZLeafWidthL0 - 1, boundsIn, treeBlockSet);

                        //3x3
                        if (posXLeafWidth <= 1 && posZLeafWidthL0 <= 1 && posZLeafWidthL0 >= -1 && posXLeafWidth >= -1) {

                            this.leafs(worldIn, posX2 + posXLeafWidth - 1, topTrunkHeight + 5, posZ2 + posZLeafWidthL0, boundsIn, treeBlockSet);

                            this.leafs(worldIn, posX3 + posXLeafWidth - 1, topTrunkHeight + 4, posZ3 + posZLeafWidthL0, boundsIn, treeBlockSet);
                        }
                        ...
                        //Bottom Leaves
                        this.leafs(worldIn, posX2 - 1, topTrunkHeight + 5, posZ2 + 2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX2 - 3, topTrunkHeight + 5, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX2 + 1, topTrunkHeight + 5, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX2 - 1, topTrunkHeight + 5, posZ2 - 2, boundsIn, treeBlockSet);

                        this.leafs(worldIn, posX3 - 1, topTrunkHeight + 4, posZ3 + 2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX3 - 3, topTrunkHeight + 4, posZ3, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX3 + 1, topTrunkHeight + 4, posZ3, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX3 - 1, topTrunkHeight + 4, posZ3 - 2, boundsIn, treeBlockSet);
