            ...
            if (!isDesiredGroundwDirtTag(worldIn, pos.offset(Direction.DOWN), Blocks.GRASS_BLOCK)) {
                ...
                for (int buildTrunk = 3; buildTrunk <= randTreeHeight; buildTrunk++) {
                    ...
                    if (buildTrunk <= randTreeHeight - 3) {
                        ...
                        this.treeLog(treeBlockSet, worldIn, mainmutable5, boundsIn);
                    }
                ...
                for (int buildRoot = 0; buildRoot <= 5; buildRoot++) {
                    ...
                    for (Direction direction : Direction.Plane.HORIZONTAL) {
                        if (direction != Direction.WEST)
                            this.treeBranch(treeBlockSet, worldIn, rootMutable.offset(direction), boundsIn);
                        if (direction != Direction.EAST)
                            this.treeBranch(treeBlockSet, worldIn, rootMutable2.offset(direction), boundsIn);
                        if (direction != Direction.NORTH)
                            this.treeBranch(treeBlockSet, worldIn, rootMutable3.offset(direction), boundsIn);
                        if (direction != Direction.SOUTH)
                            this.treeBranch(treeBlockSet, worldIn, rootMutable4.offset(direction), boundsIn);
                    }
                ...
                //Roots/Stump
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-1, 1, -4), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, 1, -4), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, 1, -4), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-4, 1, -1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, 1, -1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-4, 1, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, 1, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-4, 1, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, 1, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-1, 1, 4), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-4, 2, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, 2, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, 2, 4), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, 3, -3), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-3, 3, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(3, 3, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, 3, 3), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-4, randTreeHeight, 2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight, 2), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(5, randTreeHeight, -1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(6, randTreeHeight, -1), boundsIn);
