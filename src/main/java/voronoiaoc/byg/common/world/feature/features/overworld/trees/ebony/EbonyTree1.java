    ...
    public boolean place(Set<BlockPos> treeBlockSet, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.offset(Direction.DOWN), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight + 4, 0), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(5, randTreeHeight + 2, 3), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-2, randTreeHeight + 4, -5), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight + 5, -5), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-5, randTreeHeight + 5, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-3, randTreeHeight + 5, 1), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight + 6, -2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(6, randTreeHeight + 6, -2), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight + 6, -1), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight + 6, 2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight + 6, 5), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(7, randTreeHeight + 7, -3), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight + 7, -1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(5, randTreeHeight + 7, -1), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight + 8, -6), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight + 8, -5), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(7, randTreeHeight + 7, -5), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(8, randTreeHeight + 7, -4), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(8, randTreeHeight + 7, -3), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(6, randTreeHeight + 8, -4), boundsIn);
