...
//This sets heights for trees. Rand.nextint allows for tree height randomization. The final int value sets the minimum for tree Height.
        ...
        if (posY >= 1 && posY + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            ...
            if (((IWorld) worldIn).getBlockState(pos.down()).getBlock() != Blocks.GRASS_BLOCK && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != Blocks.SAND && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != BYGBlockList.WHITE_SAND && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != BYGBlockList.BLACK_SAND && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != BYGBlockList.PURPLE_SAND && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != BYGBlockList.PINK_SAND && ((IWorld) worldIn).getBlockState(pos.down()).getBlock() != BYGBlockList.BLUE_SAND) {
                return false;
...
//                        this.leafs(worldIn, posX1 + posXLeafWidth - 1, topTrunkHeight + 1, posZ1 + posZLeafWidthL0 - 1, boundsIn, treeBlockSet);
                        ...
                        if (posXLeafWidth <= 1 && posZLeafWidthL0 <= 1 && posZLeafWidthL0 >= -1 && posXLeafWidth >= -1) {
                            ...
                            this.leafs(worldIn, posX1 + posXLeafWidth, topTrunkHeight + 6, posZ2 + posZLeafWidthL0, boundsIn, treeBlockSet);
                        }
                        ...
                        //Bottom Leaves
                        this.leafs(worldIn, posX1, topTrunkHeight + 7, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight + 7, posZ2 + 1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight + 7, posZ2 - 1, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 1, topTrunkHeight + 7, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 + 1, topTrunkHeight + 7, posZ2, boundsIn, treeBlockSet);

                        this.leafs(worldIn, posX1, topTrunkHeight + 6, posZ2 + 2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight + 6, posZ2 - 2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 2, topTrunkHeight + 6, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 + 2, topTrunkHeight + 6, posZ2, boundsIn, treeBlockSet);

                        this.leafs(worldIn, posX1, topTrunkHeight + 6, posZ2 + 3, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight + 6, posZ2 - 3, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 3, topTrunkHeight + 6, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 + 3, topTrunkHeight + 6, posZ2, boundsIn, treeBlockSet);

                        this.leafs(worldIn, posX1, topTrunkHeight + 5, posZ2 + 3, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight + 5, posZ2 - 3, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 3, topTrunkHeight + 5, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 + 3, topTrunkHeight + 5, posZ2, boundsIn, treeBlockSet);

                        this.leafs(worldIn, posX1, topTrunkHeight + 5, posZ2 + 4, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1, topTrunkHeight + 5, posZ2 - 4, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 - 4, topTrunkHeight + 5, posZ2, boundsIn, treeBlockSet);
                        this.leafs(worldIn, posX1 + 4, topTrunkHeight + 5, posZ2, boundsIn, treeBlockSet);
