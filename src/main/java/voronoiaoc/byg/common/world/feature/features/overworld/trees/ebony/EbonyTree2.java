    ...
    public boolean place(Set<BlockPos> treeBlockSet, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.offset(Direction.DOWN), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(5, randTreeHeight - 4, -1), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-5, randTreeHeight - 2, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-4, randTreeHeight - 2, 0), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 1, 5), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, randTreeHeight + 1, 3), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(5, randTreeHeight + 2, -4), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight + 2, -3), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight + 3, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(6, randTreeHeight + 3, 2), boundsIn);
