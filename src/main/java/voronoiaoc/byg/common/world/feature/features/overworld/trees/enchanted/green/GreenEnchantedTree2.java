    ...
    public boolean place(Set<BlockPos> treeBlockSet, IWorldGenerationReader worldIn, Random rand, BlockPos pos, MutableBoundingBox boundsIn, boolean isSapling) {
        ...
        if (pos.getY() + randTreeHeight + 1 < worldIn.getMaxHeight()) {
            if (!isDesiredGroundwDirtTag(worldIn, pos.offset(Direction.DOWN), Blocks.GRASS_BLOCK)) {
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-1, randTreeHeight - 17, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, randTreeHeight - 17, 0), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 17, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight - 16, 1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-1, randTreeHeight - 16, 2), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 13, -2), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(1, randTreeHeight - 13, -1), boundsIn);
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-1, randTreeHeight - 13, 0), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-3, randTreeHeight - 11, -2), boundsIn);
                ...
                this.treeBranch(treeBlockSet, worldIn, mainmutable.add(-2, randTreeHeight - 10, -1), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight - 18, -1), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 18, 0), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, randTreeHeight - 18, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, randTreeHeight - 18, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight - 18, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, randTreeHeight - 18, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 18, 1), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight - 18, 1), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, randTreeHeight - 17, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 17, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-5, randTreeHeight - 17, -1), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, randTreeHeight - 17, 0), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 17, 0), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight - 17, 0), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight - 17, 0), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, randTreeHeight - 17, 1), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, randTreeHeight - 17, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-1, randTreeHeight - 17, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(0, randTreeHeight - 17, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(1, randTreeHeight - 17, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 17, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight - 17, 2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight - 17, 2), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-2, randTreeHeight - 13, 4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 13, 4), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(-3, randTreeHeight - 13, 5), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight - 12, 5), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(2, randTreeHeight - 12, 6), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight - 10, -5), boundsIn);
                ...
                this.leafs(treeBlockSet, worldIn, mainmutable.add(3, randTreeHeight - 10, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(4, randTreeHeight - 10, -2), boundsIn);
                this.leafs(treeBlockSet, worldIn, mainmutable.add(5, randTreeHeight - 10, -2), boundsIn);
